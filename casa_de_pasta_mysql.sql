...
create table clientes( 
	...
	direccion_entre_calles varchar(40) not null,
...
create table facturas( 
   ...
   medio_pago enum ('efectivo','tarjeta_debito','tarjeta_credito','tranferencia_bancaria','mercado_pago','uala'),
	-- Forma_de_entrega varchar (35)
			-- check(Forma_de_entrega in ('retira del local','envio a domicilio')),
	Forma_de_entrega enum ('retira del local','envio a domicilio'),
    total double,
...
create table detalles( 
   ...
   -- precio_final money,
   precio_final double,
   primary key(numero_factura,id_menu),
constraint FK_detalles_id_menu foreign key (id_menu) references menus(id),
...
/*-- inserto detalles de las clientes 
    ...
    insert into clientes (nombre_apellido,direccion_entre_calles,contacto)values ('Jose,Stuar','felix fria 3000, poeta risso y jose andonegui',29450678);
...
-- Inserto detalles de menus
    ...
    insert into menus (tipo,descripcion,precio)  values('comida','caja de sorrentinos 14 de jamon y queso',330);
